 ...
 */
export type PlayerClass<T extends TimeControl<TS>, P extends Player<T, TS, PA, PP>, TS extends TimeControlSettings = any, PA extends PlayerAttributes = any, PP extends PlayerAttributeProperties = any> = new (role: Role, game: Game<any, T, P, TS, PA, PP>, timeControl: T) => P;
/**
